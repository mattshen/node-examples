...
test("module.filename", () => {
    expect(module.filename).toBe(`${__dirname}/nodejs_module.test.js`);
});

test("module.id", () => {
    expect(module.id).toBe(`${__dirname}/nodejs_module.test.js`);
});
...
test("__filename should have some value", () => {
    expect(__filename).toBe(`${__dirname}/nodejs_module.test.js`);
});
